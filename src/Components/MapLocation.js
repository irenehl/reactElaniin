...
function MapLocation() {
    function toggleButtons(current, previous) {
        document.getElementById(current).classList.toggle('dark-out')
        document.getElementById(previous).classList.toggle('dark-out')
            ...
            <div className="row mapContainer d-flex align-items-center">
                <div className="col-12 col-md-4 d-flex flex-column">
                    ...
                    <div className="row">
                        <button 
                        id="takeaway"
                        onClick={() => toggleButtons('takeaway', 'delivery')} 
                        className="btn take-out syne col-6 dark-out">
                        ...
                        <button 
                        id="delivery"
                        onClick={() => toggleButtons('delivery', 'takeaway')} 
                        className="btn take-out syne col-6">
                            <svg className="icon" width="30" height="18" viewBox="0 0 30 18" fill="none" xmlns="http://www.w3.org/2000/svg">
